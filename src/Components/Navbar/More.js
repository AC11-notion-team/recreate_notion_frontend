...
export default function More({state,toggle}){
    return(
        <div>
            <img alt="moreButton" className="w-8 header-icon point" src={more} onClick={toggle} />
            {state && <div className="absolute border-2 box-shadow right-4 top-12 rounded">
                <div className="p-1.5">
