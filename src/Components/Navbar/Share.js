...
export default function Share({state,toggle}){

    return(
        <div >
            <p className="text-sm header-icon point"
                 onClick={toggle}>Share</p>
            {state && <div className="absolute border-2 box-shadow right-0 top-12 rounded" >
