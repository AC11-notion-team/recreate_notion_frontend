...
export default function Features (props) {
    ...
    <div className="mx-auto max-w-7xl bg-[#fffefc] "> 
        <div className="md:flex mt-20">
            ...
            <div className=" w-4/12 ml-6 mt-24 mr-12">
        ...
        <div className="md:flex mt-20">
            ...
            <div className=" w-4/12 ml-6 mt-24 mr-12">
                <img className="w-36" src="https://www.notion.so/cdn-cgi/image/format=auto,width=384,quality=100/front-static/pages/product/spot/spot-workflow.png" alt="" />
                <br />
        ...
        <div className="md:flex mt-20 ">
            ...
            <div className=" w-4/12 ml-6 mt-24 mr-12">
                <img className="w-30" src="https://www.notion.so/cdn-cgi/image/format=auto,width=128,quality=100/front-static/pages/product/spot/spot-ecosystem.png" alt="" />
                <br />
                <h2 className="text-4xl font-bold mb-6">Benefit from a global ecosystem of creators</h2>
